    ...
    <div className="space-y-8 step-enter">
      ...
      <div>
        <h3 className="text-lg font-semibold text-slate-900 mb-1 flex items-center gap-2">
          <ListTodo className="w-5 h-5 text-[#96EE52]" />
      ...
      <div>
        <h3 className="text-lg font-semibold text-slate-900 mb-1 flex items-center gap-2">
          <HelpCircle className="w-5 h-5 text-[#96EE52]" />
      ...
      <div>
        <h3 className="text-lg font-semibold text-slate-900 mb-1 flex items-center gap-2">
          <Network className="w-5 h-5 text-[#96EE52]" />
      ...
      <div>
        <h3 className="text-lg font-semibold text-slate-900 mb-1 flex items-center gap-2">
          <DatabaseBackup className="w-5 h-5 text-[#96EE52]" />
