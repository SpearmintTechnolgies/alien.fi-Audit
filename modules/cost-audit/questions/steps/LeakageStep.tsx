...
const OPTIONS: { value: LeakagePattern; label: string; sublabel: string; icon: React.ReactNode }[] = [
  {
    ...
    icon:     <FileText className="w-5 h-5 text-[#96EE52]" />,
  },
  {
