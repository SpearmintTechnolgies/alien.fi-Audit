...
import { UnitEconomic, UNIT_ECONOMICS_VALUES } from "@/modules/cost-audit/types";
...
const OPTIONS: { value: UnitEconomic; label: string; sublabel: string; icon: React.ReactNode }[] = [
  {
    ...
    icon:     <Zap className="w-5 h-5 text-[#96EE52]" />,
  },
  {
    value:    "cost_per_task",
    ...
    icon:     <CheckCircle className="w-5 h-5 text-[#96EE52]" />,
  },
  {
