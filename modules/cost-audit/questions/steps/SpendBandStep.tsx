...
import { SpendBand, SpendVisibility } from "@/modules/cost-audit/types";
...
const SPEND_OPTIONS: { value: SpendBand; label: string; icon: React.ReactNode }[] = [
  { value: "lt_5k",     label: "Less than $5k / month",  icon: <Lightbulb className="w-5 h-5 text-[#96EE52]" /> },
  { value: "5k_25k",    label: "$5k – $25k / month",     icon: <TrendingUp className="w-5 h-5 text-[#96EE52]" /> },
  { value: "25k_100k",  label: "$25k – $100k / month",   icon: <BarChart3 className="w-5 h-5 text-[#96EE52]" /> },
  { value: "100k_plus", label: "$100k+ / month",         icon: <Zap className="w-5 h-5 text-[#96EE52]" /> },
];
