...
const OPTIONS: { value: OptimizationDone; label: string; sublabel: string; icon: React.ReactNode }[] = [
  {
    ...
    icon:     <ClipboardList className="w-5 h-5 text-[#96EE52]" />,
  },
  {
    value:    "prompt_tuning",
