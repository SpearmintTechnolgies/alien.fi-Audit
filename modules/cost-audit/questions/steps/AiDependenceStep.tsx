...
import { AiDependence, AI_DEPENDENCE_VALUES } from "@/modules/cost-audit/types";
...
const OPTIONS: { value: AiDependence; label: string; sublabel: string; icon: React.ReactNode }[] = [
  {
    ...
    icon:     <Rocket className="w-5 h-5 text-[#96EE52]" />,
  },
  {
    value:    "key_workflows",
